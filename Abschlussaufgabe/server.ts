...
export namespace feuerwerkEndabgabe {
    ...
    let databaseUrl: string = "mongodb+srv://test:1234@cluster0.jkn7c.mongodb.net/Cluster0?retryWrites=true&w=majority"; // "mongodb://localhost:27017";
    ...
    async function connectToDatabase(_url: string): Promise<void> {
        ...
        fireworkCollection = mongoClient.db("eia").collection("score");
