namespace Soccer {
    export class Game {
        private participants: Soccer.Participant[] = [];
        ...
        constructor(
            ...
            this.team1 = new Team(
                ...
                Game.getHexColorFromPreset(this.settings.colorTeam1)
            );
            this.team2 = new Team(
        ...
        private static getNormDirVector(vec1: number[], vec2: number[]) {
        ...
        private static getDistance(vec1: number[], vec2: number[]) {
        ...
        private initBall() {
            this.ball = new Ball(this.fieldWidth / 2, this.fieldHeight / 2, this.fieldWidth, this.fieldHeight);
        }
